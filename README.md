...
[Telegram 機器人](https://core.telegram.org/bots/api) 與[OpenAI 的 ChatGPT](https://openai.com/blog/chatgpt/)、[DALL-E](https://openai.com/product/dall-e-2) 和 [Whisper](https://openai.com/research/whisper) API 集成，以提供答案。 只需極少的配置即可使用。
